...
SECRET_KEY = 'django-insecure-%t9@0h8akcm!45ss18-h_==f4%acq#ts*1!z-hts+^vb$_45(6'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'onlinemarketplace',          # Replace with your database name
        'USER': 'root',              # Replace with your database user
        'PASSWORD': 'boot',          # Replace with your database password
